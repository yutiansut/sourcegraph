...
import { Keybinding, KeyboardShortcut, KeyboardShortcutsProps } from './keyboardShortcuts'
                                ...
                                >
                                    ...
                                    <span>
                                        {keybindings.map((keybinding, i) => (
                                            <code key={i} className="badge badge-secondary mr-2">
                                                {keybindingKeysDescription(keybinding)}
                                            </code>
                                        ))}
                                    </span>
                                </li>
...
/**
 * Describes the keys to press to activate the keybinding.
 */
export function keybindingKeysDescription(keybinding: Keybinding): string {
    return [...(keybinding.held || []), ...keybinding.ordered].join('+')
}
